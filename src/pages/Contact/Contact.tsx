  ...
  return (
    <>
      ...
      <section className='mt-36 bg-white'>
        <div className='container mx-auto rounded-xl border-2 px-4 py-8 lg:py-16'>
          ...
          <div className='flex w-full flex-col items-start md:flex-row'>
            <form onSubmit={handleSubmit} className='w-full space-y-8 md:w-1/3'>
              <div>
              ...
              <button
                ...
                disabled={isLoading}
                type='submit'
                className='hover:bg-primary-800 focus:ring-primary-300 w-full rounded-lg bg-[var(--electric-green)] px-5 py-3 text-center text-sm font-medium text-white focus:outline-none focus:ring-4 sm:w-full'
              >
                Trimite mesajul !
              </button>
            </form>
            <div className='mt-7 w-full md:ms-8 md:w-2/3'>
