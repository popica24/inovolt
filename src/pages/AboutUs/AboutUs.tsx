        ...
        <div className='mx-0 sm:mx-6'>
          <div className='w-full bg-white p-8 text-xl leading-normal text-gray-800 md:p-24 md:text-2xl'>
            ...
            <p className='py-6' data-aos='fade-up'>
              ...
              Fier Fosfat (LiFePO4) combină capacitatea mare de stocare cu durabilitatea și siguranța, oferind o soluție
              completă pentru casele și afacerile care doresc să facă tranziția către un viitor energetic sustenabil.
            </p>
            <Gallery />
            <ol>
              ...
              <li className='py-3' data-aos='fade-up'>
                ...
                această baterie oferă o densitate energetică impresionantă. Deși greutatea de aproximativ 112kg nu este
                neglijabilă, raportul capacitate-dimensiune face ca PowerPack să fie o soluție eficientă pentru spațiile
                rezidențiale și comerciale unde fiecare metru pătrat contează. Această combinație între capacitate mare
                și dimensiuni moderate reprezintă un echilibru ideal pentru aplicațiile moderne de stocare a energiei.{' '}
              </li>
            </ol>
            ...
            <ol>
              <li className='py-3' data-aos='fade-up'>
                ...
                suportând până la 16 unități conectate simultan. Această funcționalitate permite scalarea sistemului de
                la o singură locuință până la aplicații comerciale mai mari, oferind flexibilitate pentru diverse
